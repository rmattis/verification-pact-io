...
/**
 * The matching rules are stored as a key/value map where the key is the category that matchers are
 * applied to. The matching rules supported are body, header, path, query and metadata.
 *
