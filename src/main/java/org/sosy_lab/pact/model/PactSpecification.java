 ...
 *
 * @see <a
 *     href="https://github.com/pact-foundation/pact-specification/tree/version-4#file-format">Pact
...
public record PactSpecification(
    PactConsumer consumer, PactProvider provider, List<PactInteraction> interactions) {}
